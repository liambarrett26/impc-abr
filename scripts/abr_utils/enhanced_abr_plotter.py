...
Usage:
python scripts/abr_utils/enhanced_abr_plotter.py "results/bootstrap_incremental_Pank2/Pank2<em1(IMPC)Ccpcz>_homozygote_CCP-IMG/Pank2<em1(IMPC)Ccpcz>_homozygote_CCP-IMG_all"
