...
SUPP_DIR = Path(
    "/Users/liambarrett/Library/CloudStorage/"
    "OneDrive-UniversityCollegeLondon/evident/projects/impc/supp_mats"
)
FOREGROUND_FILE = SUPP_DIR / "supplementary_file_4_bayesian_results_significant_annotated.csv"
...
SOLR_FIELDS = [
    "marker_symbol", "allele_symbol", "phenotyping_center",
    "procedure_name", "procedure_stable_id",
    "parameter_name", "parameter_stable_id",
    "top_level_mp_term_id", "top_level_mp_term_name",
    "intermediate_mp_term_id", "intermediate_mp_term_name",
    "mp_term_id", "mp_term_name",
    "zygosity", "p_value", "effect_size",
    "life_stage_name", "sex",
]

# Acoustic-dependent keyword patterns for circularity classification
ACOUSTIC_KEYWORDS = [
    "pinna reflex", "preyer", "startle reflex", "acoustic startle",
    "auditory", "hearing", "cochlea", "deaf", "ABR", "click-evoked",
]
ACOUSTIC_PROCEDURES = ["IMPC_ABR_"]  # procedure_stable_id prefix

VESTIBULAR_KEYWORDS = [
    "vestibular", "head bobbing", "circling", "trunk curl",
    "head tilt", "balance", "righting",
]
