#!/usr/bin/env python
# -*- coding: utf-8 -*-
# tests/test_bayes_Cib2.py

"""
Test analysis pipeline using Cib2 as a known hearing loss gene.
...
def test_bayesian_Cib2_analysis():
    """Test Bayesian analysis pipeline using Cib2 as a known hearing loss gene."""
    ...
    # Find experimental groups for Cib2
    gene_symbol = 'Cib2'
