#!/usr/bin/env python
# -*- coding: utf-8 -*-
# tests/test_bayes_Marveld2.py

"""
Test analysis pipeline using Marveld2 as a known hearing loss gene.
...
def test_bayesian_Marveld2_analysis():
    """Test Bayesian analysis pipeline using Marveld2 as a known hearing loss gene."""
    ...
    # Find experimental groups for Marveld2
...
if __name__ == "__main__":
    test_bayesian_Marveld2_analysis()