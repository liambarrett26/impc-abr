#!/usr/bin/env python
# -*- coding: utf-8 -*-
# tests/test_bayes_Sun1.py

"""
Test analysis pipeline using Sun1 as a known hearing loss gene.
...
def test_bayesian_Sun1_analysis():
    """Test Bayesian analysis pipeline using Sun1 as a known hearing loss gene."""
    ...
    # Find experimental groups for Sun1
    gene_symbol = 'Sun1'
