#!/usr/bin/env python
# -*- coding: utf-8 -*-
# tests/test_bayes_Ocm.py

"""
Test analysis pipeline using Ocm as a known hearing loss gene.
...
def test_bayesian_Ocm_analysis():
    """Test Bayesian analysis pipeline using Ocm as a known hearing loss gene."""
    ...
    # Find experimental groups for Ocm
    gene_symbol = 'Ocm'
